...
public class Main {
    ...
    public static void main(String[] args) {
        String fileName = "src/main/java/file1.txt";
        System.out.println("Task 1. Valid Phone Numbers:");
        validPhoneNumber(fileName);
        fileName = "src/main/java/file2.txt";
        System.out.println("\nTask 2. Text to objects and then to Json:");
        userJson(fileName);
        fileName = "src/main/java/words.txt";
        System.out.println("\nTask 3. Counting amount of words in the file words.txt:");
        words(fileName);
    }
    ...
    public static void userJson(String fileName) {
        ...
        try (FileWriter writer = new FileWriter("src/main/java/user.json", false)) {
            writer.write(json);
            writer.flush();
